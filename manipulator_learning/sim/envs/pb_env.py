...
class PBEnv(gym.Env):
    ...
    def __init__(
        ...
        # self.robot_base_ws_cam_tf = ((0, 1, 0.4), (-2/3*np.pi, 0, -np.pi))
        ...
        obj_random_lim = tuple([(0.15, 0.15, 0) for _ in range(block_num)] + [(0, 0, 0), (0, 0, 0)])
        obj_urdf_names = tuple([("cube_blue_small") for _ in range(block_num)] + [("coaster"), ("coaster")])
